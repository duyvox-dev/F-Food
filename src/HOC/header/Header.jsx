...
function Header() {
	...
	return (
		<div className="header__wrapper"><Container maxWidth='lg'
				...
				{_.isEmpty(user)
					...
					<div className='profileContainer' style={{ position: "relative" }} >
						...
						>
							...
							<MenuItem onClick={toggleMenu} sx={{ padding: "1rem" }}><Link to='/profile' className='dropdownItem'>
								<AccountCircleIcon />
								<div className='nameItem'>Tài khoản của tôi</div>
							</Link></MenuItem>
							<MenuItem onClick={toggleMenu} sx={{ padding: "1rem" }}><Link to='/order-history' className='dropdownItem'>
								<InventoryOutlinedIcon />
								<div className='nameItem'>Đơn mua</div>
							</Link></MenuItem>
							<MenuItem onClick={toggleMenu} sx={{ padding: "1rem" }}><div className='dropdownItem' onClick={() => { handleLogout() }}>
								<LogoutIcon />
