	...
	return (
		<div className='order-section'>
			<div className='heading-flex'>
				...
				<span className='heading-change'>Đổi địa điểm</span>
			</div>
			<div className='box-content' elevation={0}>
				<span className='box-content-heading'>Phòng 202</span>
				<div>
					<span className='box-content-title'>Thời gian giao hàng dự kiến</span>
					<span className='box-content-info'>9:15 - 9:45 (Giữa slot 1 - slot 2)</span>
				</div>
			</div>
		</div>
	);
